	...
	return (
		<div className='flex flex-col'>
			...
			<main className='md:flex flex-row justify-center items-center w-full h-full overflow-auto md:overflow-hidden bg-light dark:bg-customBgDark'>
				<section className='flex flex-col w-full md:w-1/2 md:pl-16 mt-8 md:mt-0 '>
					<p className='md:text-3xl text-dark900 text-pretty text-center md:text-start tracking-wide font-poppins mt-5 mx-5 md:mx-0 md:mt-0 md:mb-32 dark:text-customTextLight'>
						...
						emprendimiento!! crear un monopolio con{' '}
						<strong>
							SHIFT
							<span className='text-violet-700'>NET.</span>
						</strong>
					</p>
				</section>
