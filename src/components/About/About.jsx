	...
	return (
		<article className='flex flex-col p-2 w-full rounded-md border border-blue-zodiac-400 mt-5'>
			...
			<p className='text-dark dark:text-light p-1'>
				...
				alias sit, eveniet amet vel quibusdam praesentium dignissimos atque
				tenetur? Asperiores! Lorem ipsum dolor sit amet consectetur adipisicing
				elit. Consequatur omnis magnam unde veniam in provident itaque
